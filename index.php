<!--doctype--><html><head> 
	...
	<script src=acudits.js>/** variable Acudits **/</script>
	<script>
		var mostrats=0; //nº d'acudits mostrats
		function acudit() {
...
<!--footer-->
<div id=footer> Acudits aleatoris 2013-2018 — Creat per <a href="http://twitter.com/LluisMa">Lluís Mª Bosch</a></div>
